...
def reproduce_fig_7_3():
    ...
    # 1. Sign: Thesis action is negative (bound state energy).
    # My current code L_eff = Integral Q dQ [...] is positive for Scalar QED.
    # For Fermion QED, it should be negative.
    # Multiply by -1.
