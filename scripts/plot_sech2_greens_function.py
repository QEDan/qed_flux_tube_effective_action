...
def plot_sech2_greens_function_agreement():
    print("--- Generating Enhanced Sech2-Shell Green's Function Comparison Plot ---")
    ...
    # Residuals
    residual = np.abs(g_num_diag - g_vac_diag)
    ...
    axes[0].set_title("Numerical vs Analytic Green's Function (Sech2-Shell)")
    ...
    print("Enhanced plot saved to results/sech2_greens_function_comparison.png")
