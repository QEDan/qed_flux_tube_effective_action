...
# This file was *autogenerated* from the file symbolic_validations/derive_sech2_shell.sage
from sage.all_cmdline import *   # import sage library

_sage_const_0 = Integer(0); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1)# SageMath Script: Derive and Validate Sech2 Shell Math
from sage.all import *

# Define symbols
x, rho, R, lambd, B0, e, sigma3, m = var('x rho R lambd B0 e sigma3 m')
assume(lambd > _sage_const_0 , B0 > _sage_const_0 , R > _sage_const_0 )
...
V_1d = e * sigma3 * B_1d + e**_sage_const_2  * Ay**_sage_const_2 
print(f"1D Potential: V(x) = {V_1d.simplify_full()}")

# Rewrite using sech^2 = 1 - tanh^2
V_1d_rewritten = V_1d.subs(tanh(x/lambd)**_sage_const_2  == _sage_const_1  - sech(x/lambd)**_sage_const_2 ).simplify_full()
...
Aphi_approx = (R/rho) * B0 * lambd * (tanh((rho - R)/lambd) + _sage_const_1 )
...
ml = var('ml')
B_cyl = B0 * sech((rho - R)/lambd)**_sage_const_2 
V_cyl = e * sigma3 * B_cyl + (_sage_const_1 /rho**_sage_const_2 ) * ((ml - e*rho*Aphi_approx)**_sage_const_2  - _sage_const_1 )
...
V_cyl_expanded = V_cyl_limit.series(R, _sage_const_2 ).truncate()
