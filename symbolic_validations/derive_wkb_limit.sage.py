...
# This file was *autogenerated* from the file symbolic_validations/derive_wkb_limit.sage
from sage.all_cmdline import *   # import sage library

_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2)# SageMath Script: Derive and Validate WKB Limit for Numerical Solver
from sage.all import *

# Define symbols
rho, chi, m, ml, e, B0, lambda_len = var('rho chi m ml e B0 lambda_len')
assume(chi > _sage_const_0 , rho > _sage_const_0 )
...
k = var('k')
S0 = k * rho
S1 = -_sage_const_1 /_sage_const_2  * log(rho)
...
wkb_wronskian = (u_wkb * diff(u_wkb, rho, _sage_const_1 ) - diff(u_wkb, rho, _sage_const_1 ) * u_wkb) # Note: W(f,g) = f*g' - f'*g
...
# V_eff = V_ml + 1/rho^2
# S2' = (V_eff) / 2k
V_eff = (ml**_sage_const_2  - _sage_const_1 ) / rho**_sage_const_2  # Simplified potential
S2_prime = V_eff / (_sage_const_2 *k)
