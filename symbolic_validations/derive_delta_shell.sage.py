...
# This file was *autogenerated* from the file symbolic_validations/derive_delta_shell.sage
from sage.all_cmdline import *   # import sage library

_sage_const_0 = Integer(0); _sage_const_1 = Integer(1)# SageMath Script: Derive and Validate Delta-Function Shell Math
from sage.all import *

# Define symbols
rho, R, kappa, ml, e, F, sigma3 = var('rho R kappa ml e F sigma3')
assume(R > _sage_const_0 , kappa > _sage_const_0 )
...
print(f"C1 = {sol[_sage_const_0 ][_sage_const_0 ].rhs().simplify_full()}")
print(f"C2 = {sol[_sage_const_0 ][_sage_const_1 ].rhs().simplify_full()}")
...
print(f"D1 = {sol_inf[_sage_const_0 ][_sage_const_0 ].rhs().simplify_full()}")
print(f"D2 = {sol_inf[_sage_const_0 ][_sage_const_1 ].rhs().simplify_full()}")

# 5. Wronskian Verification
W0 = rho * (du0_in * u_inf_in - u0_in * du_inf_in)
W0_val = W0.subs(rho=R).subs(sol_inf[_sage_const_0 ][_sage_const_0 ], sol_inf[_sage_const_0 ][_sage_const_1 ]).simplify_full()
print(f"\nWronskian W0 (should be constant and independent of jump if matched correctly):")
print(f"D2 (coeff of K_ml in interior) = {sol_inf[_sage_const_0 ][_sage_const_1 ].rhs().simplify_full()}")
